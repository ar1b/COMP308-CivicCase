...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    { from: 'bot', text: "Hi! I'm CivicBot 🤖 I'm powered by LangGraph + Gemini and have live access to community data. Ask me about issues, trends, or urgent alerts!" }
  ])
    ...
    <div className="fixed bottom-6 right-6 z-50">
      {open ? (
        <div className="bg-white rounded-2xl shadow-2xl w-80 flex flex-col overflow-hidden border border-gray-200" style={{ height: '480px' }}>
          <div className="bg-blue-700 text-white px-4 py-3 flex justify-between items-center flex-shrink-0">
            <div>
